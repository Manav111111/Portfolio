  ...
  return (
    <>
          ...
          <div className="container mx-auto max-w-6xl flex items-center justify-between">
            ...
            <ul className="desktop-nav flex items-center gap-8 list-none m-0 p-0">
              ...
              <li className="m-0 p-0">
                <a href="/manav_gupta_resume.pdf" target="_blank" rel="noopener noreferrer" className="resume-btn">
      ...
      <div className={`mobile-nav ${isMobileMenuOpen ? "open" : ""}`}>
        ...
        <a href="/manav_gupta_resume.pdf" target="_blank" rel="noopener noreferrer" className="resume-btn mt-4">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
            <polyline points="7 10 12 15 17 10" />
            <line x1="12" y1="15" x2="12" y2="3" />
